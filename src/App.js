...
const projects = [
  {
    ...
    detail:
      "A full-stack marketplace built with a React and Redux frontend plus a modular Express API. The backend includes MongoDB, Redis, JWT authentication, Stripe payments, Cloudinary uploads, Socket.IO, Swagger documentation, validation, rate limiting, and security middleware.",
  ...
  },
  {
    ...
    detail:
      "A separate React and Vite client with Zustand state management, backed by an Express server using Socket.IO and JWT authentication. The repository separates routes, middleware, socket handlers, client pages, components, hooks, and stores.",
  ...
  },
  {
    ...
    detail:
      "A React and TypeScript application built with Vite, Supabase, TanStack Query, React Hook Form, Zod, Tailwind CSS, Radix UI components, charts, and Vitest. The project demonstrates a broad modern frontend architecture with hosted data integration.",
  ...
  },
  {
    ...
    detail:
      "A compact PHP and MySQL application with registration and login, a user dashboard, stored progress data, statistics, and separate study, reading, and music activity workflows.",
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box className="site-shell">
        ...
        <AppBar position="fixed" elevation={0} className="nav-bar">
          <Container maxWidth="xl" className="wide-container">
            <Toolbar disableGutters>
              ...
              >
                Available for work <span className="pulse-dot" />
              </Button>
              <IconButton
        ...
        <Box component="main" id="top">
          <Container maxWidth="xl" className="wide-container">
            <Box component="section" className="hero">
              ...
              <Typography className="hero-copy">
                ...
                thoughtful interfaces where clarity meets character.
              </Typography>
              <Stack
              ...
              <Typography className="scroll-note">
                SCROLL TO WANDER <span>↓</span>
              </Typography>
            </Box>
            ...
            >
              <Box className="portrait-constellation">
                <Box className="portrait-window">
                  <img
                    src="/sadeepa-portrait.png"
                    alt="Sadeepa standing outdoors"
                  />
                  <span className="portrait-caption">
                    Sadeepa · Designer & developer
                  </span>
                </Box>
              ...
              <Box>
                ...
                <Typography className="about-copy">
                  I care about the invisible details: the pause before a
                  transition, the sentence that removes doubt, the structure
                  that lets a product grow. My work sits between systems
                  thinking and visual storytelling.
                </Typography>
                <Typography className="about-copy">
                  Away from the screen, I’m usually photographing quiet streets,
                  collecting old print, or learning something impractical.
                </Typography>
                ...
                {visibleProjects.map((project) => (
                  ...
                  >
                    ...
                    <Box className="project-body">
                      ...
                      <Button color="primary" className="case-link">
                        View project ↗
                      </Button>
                    </Box>
                  </Box>
            ...
            >
              ...
              <Typography className="stack-intro">
                A practical full-stack toolkit for building, shipping, and
                maintaining modern web applications.
              </Typography>
            ...
            <Box
              component="section"
              id="certificates"
              className="section-block certificates-section"
            >
              ...
              >
                ...
                <Typography className="certificate-intro">
                  Verified course completion in development, DevOps, cloud, and
                  AI fundamentals.
                </Typography>
              </Stack>
              <Box className="certificate-bar">
                {certificates.map((certificate, index) => (
                  ...
                  >
                    ...
                    <Box>
                      <Typography className="certificate-issuer">
                        {certificate.issuer} · {certificate.date}
                      </Typography>
                      <Typography variant="h5">{certificate.title}</Typography>
                    </Box>
                    <Typography className="credential-id">
              ...
              <Typography className="swipe-note">
                Scroll horizontally to view all credentials →
              </Typography>
            </Box>
          </Container>
          ...
          <Box component="section" id="contact" className="contact-section">
            <Container maxWidth="md">
              ...
              <Typography color="text.secondary">
                Tell me what you’re building, where it stands, and what kind of
                help you need.
              </Typography>
              <Box
                component="form"
              ...
              <Box component="footer" className="footer">
                <Typography>© 2026 Sadeepa.</Typography>
                <Stack direction="row" spacing={3}>
                  ...
                  <Link href="mailto:hello@sadeepa.dev">Email</Link>
                </Stack>
              </Box>
            </Container>
          </Box>
        ...
        <Dialog
          ...
          maxWidth="sm"
          fullWidth
          PaperProps={{ className: "case-dialog" }}
        >
          {selectedProject && (
            <>
              <DialogTitle>
              ...
              <DialogContent>
                ...
                <Stack direction="row" gap={1} mt={3} sx={{ flexWrap: "wrap" }}>
